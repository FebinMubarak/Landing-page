  ...
  return (
    <div  className='footer'>
        <div className='footerheading'>
         <Fade bottom duration={3500}><Card 
         ...
         <Fade bottom duration={4500}><Card
         ...
         <Fade left duration={2500}> <img  className='img3' src={home} alt="" /></Fade>
        <Fade right duration={2500}> <img className='img4' src={home2} alt="" /></Fade>
    </div>
  )
}
